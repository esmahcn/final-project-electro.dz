...
function Products() {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get("https://final-project-electrodz-backend.onrender.com/api/products");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingProduct) {
        // UPDATE product
        await axios.put(
          `https://final-project-electrodz-backend.onrender.com/api/products/${editingProduct._id}`,
          formData,
        ...
        // CREATE new product
        await axios.post(
          "https://final-project-electrodz-backend.onrender.com/api/products",
          formData,
          { headers: { "Content-Type": "multipart/form-data" } }
        );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this product?")) {
      try {
        await axios.delete(`https://final-project-electrodz-backend.onrender.com/api/products/${id}`);
